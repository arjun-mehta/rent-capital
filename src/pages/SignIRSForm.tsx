        ...
        <div ref={formRef} className="bg-white p-6 rounded-lg border mb-8">
          ...
          <div className="flex flex-col items-center">
            <p className="text-gray-600 mb-4 text-center max-w-xl">
              By continuing, you acknowledge that you have reviewed the IRS Form
              4506-T and authorize Creator Capital to use it for income
              verification.
            </p>

            <Button
              onClick={handleContinue}
              className="bg-primary hover:bg-primary/90 text-primary-foreground py-5 px-6 text-base gap-2 min-w-[300px]"
            >
