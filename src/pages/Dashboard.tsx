...
import { BadgeCheck, Download, CreditCard, Calendar, ArrowRight, Bell, Shield, CheckCircle2, Building } from "lucide-react";
...
const Dashboard: React.FC = () => {
  ...
  const handleConnectBank = () => {
    ...
    toast({
      ...
      description: "You'll be redirected to securely connect your bank account.",
    });
    ...
    <div className="min-h-screen flex flex-col bg-[#FCF7F0]">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="max-w-7xl w-full mx-auto">
          <h2 className="text-3xl font-bold text-gray-800 mb-10 text-center">Final Steps</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {/* Connect Bank Card */}
            <Card className="overflow-hidden bg-white shadow-lg border-0 rounded-2xl">
              <CardContent className="p-0">
                <div className="bg-gradient-to-r from-[#015e44] to-[#017354] p-6">
                  ...
                  <h3 className="text-white text-2xl font-semibold mt-4">Connect Bank Account</h3>
                </div>
                
                <div className="p-8">
                  <div className="mb-8">
                    <p className="text-gray-600 text-lg leading-relaxed">
                      Link your bank account securely to receive your funds. Our bank connection process uses industry-standard encryption to protect your information.
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl">
                    <div className="flex items-center mb-4">
                      <div className="h-10 w-10 rounded-full bg-[#e6f2ee] flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#017354]" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                      </div>
                      <div className="ml-3">
                        <h4 className="font-medium text-gray-900">Secure & Encrypted</h4>
                        <p className="text-sm text-gray-500">Bank-level security protocols</p>
                      </div>
                    </div>
                    
                    <Button 
                      className="w-full bg-[#017354] hover:bg-[#015e44] text-white py-6 text-lg font-medium rounded-xl transition-colors duration-200"
            ...
            <Card className="overflow-hidden bg-white shadow-lg border-0 rounded-2xl">
              <CardContent className="p-0">
                <div className="bg-gradient-to-r from-[#015e44] to-[#017354] p-6">
                  ...
                  <h3 className="text-white text-2xl font-semibold mt-4">Download Chrome Extension</h3>
                </div>
                
                <div className="p-8">
                  <div className="mb-8">
                    <p className="text-gray-600 text-lg leading-relaxed">
                      Our Chrome extension enables seamless payment processing from your Patreon account and provides easy access to your Creator Capital dashboard.
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl">
                    <div className="flex items-center mb-4">
                      ...
                      <div className="ml-3">
                        <h4 className="font-medium text-gray-900">Simple Installation</h4>
                        <p className="text-sm text-gray-500">Takes less than 30 seconds</p>
                      </div>
                    </div>
